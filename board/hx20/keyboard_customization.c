...
// smumriak changes:
// Left Alt -> Left Win (0x0011 -> 0xe01f)
// Left Win -> Left Alt (0xe01f -> 0x0011)
// Right Alt -> Right Win (0xe011 -> 0xe027)
// Right Ctrl -> Right Alt (0xe014 -> 0xe011)
// Left Control (0x) and Fn (0x00ff) are swapped
uint16_t scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
		{0x0021, 0x007B, 0x0079, 0x0072, 0x007A, 0x0071, 0x0069, 0xe04A},
		{0xe071, 0xe070, 0x007D, 0x0011, 0x006c, 0xe06c, 0xe07d, 0x0077},
		{0x0015, 0x0070, 0x0014, 0x000D, 0x000E, 0x0016, 0x0067, 0x001c},
		{0xe027, 0xe01f, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000},
		...
		{0xe011, 0x00ff, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000},
