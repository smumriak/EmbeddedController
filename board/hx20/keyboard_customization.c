...
// smumriak changes:
// Left Alt (0x0011) <-> Left Win (0xe01f)
// Right Alt 0xe011) <-> Right Win (0xe027)
// Left Control (0x0014) <-> Fn (0xe0ff)
// Fn is changed from 0x00ff to 0xe008
uint16_t scancode_set2[KEYBOARD_COLS_MAX][KEYBOARD_ROWS] = {
		...
		{0xe011, 0xe008, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000},
